...
import com.example.demomvvm.databinding.ItemPokemonBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ITEMPOKEMON = 2;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(2);

  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.demomvvm.R.layout.activity_main, LAYOUT_ACTIVITYMAIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.demomvvm.R.layout.item_pokemon, LAYOUT_ITEMPOKEMON);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/item_pokemon_0", com.example.demomvvm.R.layout.item_pokemon);
    }
  }
}
